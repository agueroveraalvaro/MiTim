package com.mitim.spiderman.mitim.AnimationRecyclerView;
...
public abstract class AnimationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    @Override public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        System.out.println("if (!isFirstOnly || adapterPosition > mLastPosition)");
        for (Animator anim : getAnimators(holder.itemView))
        {
            System.out.println("for (Animator anim : getAnimators(holder.itemView))");
